...
- `makefiles/__app_root_template.mk` - `app/<app_name>/makefile` 用テンプレート
...
- `bin/` 配下の Python スクリプトで日本語を出力するときは、モジュールレベル (関数定義より前) に
  以下を追加して stdout/stderr を UTF-8 に固定すること。
